...
Figure \ref{fig:P1116384_bezier} shows that the shape of a sample of _Acer pseudoplatanus_ can be described by a Bézier curve.
Figure \ref{fig:P1116641_bezier} shows the same for _Acer platanoides_.
Figure \ref{fig:P1116588_bezier} shows the same for _Acer campestre_.
