...
```{r feret_width_four_acer_samples, fig.cap="\\label{fig:feret_width_two_platanoides_samples}Feret lengths and maximum widths of four samples of Acer species."}
my_data_longer |> ggplot(
  mapping = aes(
    x = label,
    y = value,
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
```
```{r Ratio, fig.cap="\\label{fig:Ratio}Length/width ratios of four samples of Acer species"}
my_data_longer |> ggplot(
  mapping = aes(
    x = label,
    y = ratio,
