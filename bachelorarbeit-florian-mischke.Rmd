...
# Kurven plotten
ggplot(bezier_df, aes(x = X, y = Y, group = FileName.x, color = FileName.x, linetype = Species)) +
...
# Kurven plotten
ggplot(bezier_df, aes(x = X, y = Y, group = FileName.x, color = Species, linetype = FileName.x)) +
