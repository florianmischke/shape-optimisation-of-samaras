...
1. _Acer campestre_ - Loki Schmidt Garten, Hamburg - what3words:  [///kennels.slippery.hears](https://w3w.co/kennels.slippery.hears)
2. _Acer pseudoplatanus_ - Stadtpark, Hamburg - what3words:  [///engaging.survey.spout](https://w3w.co/engaging.survey.spout)
3. _Acer platanoides_ - Spannskamp, Hamburg - what3words:  [///bristle.ruins.curated](https://w3w.co/bristle.ruins.curated)
4. _Acer platanoides_ - IPM, Hamburg - what3words:
...
Figure \ref{fig:labelx} shows ...

```{r, echo=FALSE, out.width="100%", fig.align = "center", fig.show='hold', fig.cap="Bézier curve on a sample of Acer pseudoplatanus\\label{fig:labelx}. Source: own work"}
